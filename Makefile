...
all: force
	cr16-c-elf-gcc -L "$$HOME/opt/cross/cr16-c-elf/lib/" -I "$$HOME/opt/cross/cr16-c-elf/include/" -mcr16c -Wall -Wextra -Wimplicit-function-declaration -Wredundant-decls -Wmissing-prototypes -Wstrict-prototypes -Wundef -Wshadow -Wstrict-prototypes -Wno-unused -Werror=return-type -nostartfiles -Wl,-lgcc -Wl,--gc-sections -Wl,--print-memory-usage -Wl,-L -Wl,"$HOME/opt/cross/lib/gcc/cr16-c-elf/10.4.0/" -I "$HOME/opt/cross/lib/gcc/cr16-c-elf/10.4.0/include/" -T sc14441-uart.ld crt0.s test.c -o test; \
